...
X_train, X_test, y_train, y_test = train_test_split(room , acc, test_size = 0.3, random_state = 7)
...
combo = X[['Enroll', 'Room.Board']]
accepted = X['Accept']
accepted = accepted.to_frame()
X_train, X_test, y_train, y_test = train_test_split(combo , accepted, test_size = 0.3, random_state = 7)
