...
km = KMeans(n_clusters = 2, max_iter = 300, n_init = 10)
km.fit(user1)
cen =  km.cluster_centers_
print cen
ax.scatter (cen[:,0], cen[:,1], marker = '*', c= 'blue', alpha = 0.5)
