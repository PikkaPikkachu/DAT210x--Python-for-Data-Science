...
X['wheat_type'] = X['wheat_type'].astype("category").cat.codes
...
benchmark(dtc, X_train, X_test, y_train, y_test, 'Decision Tree')
drawPlots(dtc, X_train, X_test, y_train, y_test, 'Decision Tree')
